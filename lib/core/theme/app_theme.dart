...
class AppTheme {
  ...
  static final Color primaryColor = Color(0xFF988F3E);
  ...
  static const Color secondaryColor = Color(0xFF286291);
  static const Color accentColor = Color(0xFF66BB6A);

  // ——— Accents ———
  static final Color offerColor = Color(0xD2651818);
  static final Color error = Color(0xffE53935);
  static final Color starColor = Color(0xFF286291);
  static final Color successColor = Color(0xFF286291);
