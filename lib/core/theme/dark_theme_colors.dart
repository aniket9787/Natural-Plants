...
class DarkThemeColors {
  ...
  static const Color primaryGreen = Color(0xFF175C1A); // Main brand color
  static const Color primaryGreenLight = Color(0xFF286291); // Light variant
  static const Color primaryGreenDark = Color(0xFF9FE535); // Dark variant
